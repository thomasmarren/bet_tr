...
Matchup.create(name: "Wallapolooza", odds: 10, deadline: DateTime.new(2018, 5, 9), matchup_type_id: 4)
Matchup.create(name: "Painocorpia", odds: 1, deadline: DateTime.new(2016, 11, 16), matchup_type_id: 2)
...
Bet.create(user_id: 1, matchups_competitors_id: 1, amount: 30)
Bet.create(user_id: 2, matchups_competitors_id: 2, amount: 22)
Bet.create(user_id: 3, matchups_competitors_id: 3, amount: 5)
Bet.create(user_id: 4, matchups_competitors_id: 4, amount: 11)
Bet.create(user_id: 2, matchups_competitors_id: 5, amount: 12)
Bet.create(user_id: 1, matchups_competitors_id: 6, amount: 10)
